<div align="center">
  <h1>FocusSpace</h1>
  <p><b>A calm, precise, and distraction-free focus system.</b></p>
</div>
...
1. **Minimal**: No heavy UI. No unnecessary buttons. Just clean typography and negative space.
2. **Calm**: Time shouldn't feel like a ticking bomb. The custom timer digit animations drift softly, making time feel like it's flowing naturally.
3. **Intentional**: Every interaction—from toggling the theme to starting a session—is accompanied by a deliberate, tactile transition and intelligent micro-copy feedback.

## 🛠 Tech Stack

Built entirely with standard web technologies for maximum performance, bulletproof stability, and zero bloat:

- **HTML5**: Semantic structure.
- **CSS3**: Vanilla CSS utilizing custom properties, glassmorphism, responsive clamps, safe-area variables, and touch-optimized media queries.
- **JavaScript (ES6)**: A lightweight, custom-built rendering and Web Audio synthesis engine to manage the timer, audio states, and local storage data without any external frameworks.

## 🏁 Get Started

Just open `index.html` in any modern web browser. Tap anywhere to quietly initialize the native ambient audio engine, set your intention, and step into the zone.

<div align="center">
  <br>
  <i>Stay locked in. One step at a time.</i>
  <br>
</div>
